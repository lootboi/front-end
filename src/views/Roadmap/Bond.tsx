    ...
    <Switch>
      ...
      <Container>   
              <Grid item xs={12} md={12} lg={12} >     
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Grape staking for YShare rewards ✅</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- YShare governance voting through snapshot ✅</p>      
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Integrate weekly YShare raffle on site ✅</p>                  
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Lending & borrowing of Grape & YShare on site</p>
